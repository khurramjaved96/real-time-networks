...
//    float lambda = 0.90;
//    TraceConditioning tc1 = TraceConditioning(std::pair<int, int>(20, 20), std::pair<int, int>(20, 20), std::pair<int, int>(60, 100), 5, 2);
//    TraceConditioning tc2 = TraceConditioning(std::pair<int, int>(4, 4), std::pair<int, int>(4, 4), std::pair<int, int>(60, 100), 5, 2);
//    TraceConditioning tc = TraceConditioning(std::pair<int, int>(20, 20), std::pair<int, int>(20, 20), std::pair<int, int>(60, 100), 5, 2);
...
//    Metric state_metric = Metric(my_experiment.database_name, "state", std::vector<std::string>{"step", "run", "elem1", "elem2", "elem3", "pred", "target"}, std::vector<std::string>{"int", "int", "real", "real", "real", "real", "real"}, std::vector<std::string>{"step", "run"});
//    Metric network_size = Metric(my_experiment.database_name, "synapses", std::vector<std::string>{"step", "run", "total_synapses"}, std::vector<std::string>{"int", "int", "int"}, std::vector<std::string>{"step", "run"});
...
//            print_vector(cur_state);
//        }
//        if(counter % 1500000 == 799999){
//            tc = tc2;
//        }
//        if(counter % 1500000 == 1490000){
//            tc = tc1;
//        }
...
//
////
//// Created by Khurram Javed on 2021-05-17.
////
//
