...
//            }
//            if(layer == 0)this->input_neuron.push_back(n);
...
//    {
//        this->adjacency_matric[all_synapse->input_neuron->id][all_synapse->output_neuron->id] = 1;
//    }
////    std::cout << "Before index " << all_synapses[0].input_neuron->id << std::endl;
////    std::random_shuffle ( all_synapses.begin(), all_synapses.end() , myrandom);
////    std::cout << "After index " << all_synapses[0].input_neuron->id << std::endl;
//}
//
//
...
//    for(auto & all_synapse : this->all_synapses)
//    {
//        this->adjacency_matric[all_synapse->input_neuron->id][all_synapse->output_neuron->id] = all_synapse->output_neuron->depth;
//    }
//}
//void NeuralNetwork::set_input_values(std::vector<float> const &input_values) {
////    assert(input_values.size() == this->input_neuron.size());
//    for(int i = 0; i<input_values.size(); i++)
//    {
////        std::cout << "Input neuron incoming synapses = " << this->input_neuron[i]->incoming_synapses.size() << " " <<  this->input_neuron[i]->outgoing_synapses.size() <<  std::endl;
//        this->input_neuron[i]->value = input_values[i];
//    }
//}
//
