...
int ContinuallyAdaptingRecurrentNetworkTest::get_total_neurons() {
...
void ContinuallyAdaptingRecurrentNetworkTest::viz_graph() {
...
std::string ContinuallyAdaptingRecurrentNetworkTest::get_viz_graph() {
    NetworkVisualizer netviz = NetworkVisualizer(this->all_neurons);
...
void ContinuallyAdaptingRecurrentNetworkTest::set_print_bool() {
    std::cout
...
int ContinuallyAdaptingRecurrentNetworkTest::get_input_size() {
    return this->input_neurons.size();
}

int ContinuallyAdaptingRecurrentNetworkTest::get_total_synapses() {
...
void ContinuallyAdaptingRecurrentNetworkTest::set_input_values(std::vector<float> const &input_values) {
...
std::vector<float> ContinuallyAdaptingRecurrentNetworkTest::read_all_values() {
    std::vector<float> output_vec;
...
float ContinuallyAdaptingRecurrentNetworkTest::introduce_targets(std::vector<float> targets) {
    float error = 0;
