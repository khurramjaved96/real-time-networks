...
//
//
//ContinuallyAdaptingRecurrentNetwork::ContinuallyAdaptingRecurrentNetwork(float step_size, int seed, int no_of_input_features) {
//  this->time_step = 0;
//  this->mt.seed(seed);
...
//    auto syn_2 = new synapse(nullptr, nullptr, dist_recurren(this->mt), step_size);
//
//    Neuron *recurrent_neuron = new RecurrentReluNeuron(false, false, syn_2);
